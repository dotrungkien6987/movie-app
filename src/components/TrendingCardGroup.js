...
function TrendingCardGroup({ trendingList, cutInitial, loadingTrending }) {
  ...
  // function handleList() {
  //   if (copiedList.length <= 4) {
  //     setCopiedList([...trendingList]);
  //     return trendingList.slice(0, 4);
  //   } else {
  //     const newCopiedList = copiedList.slice(4);
  //     const newList = copiedList.slice(0, 4);
  //     setCopiedList(newCopiedList);
  //     return newList;
  //   }
  // }
